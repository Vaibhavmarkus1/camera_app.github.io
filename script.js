...
let vidRecorderBtn = document.querySelector("#record-video");
...
vidRecorderBtn.addEventListener("click", function () {
    if (!recordState) {
        mediaRecorder.start();
        recordState = true;
        vidRecorderBtn.innerText = "Recording...";
    }
    else {
        mediaRecorder.stop();
        recordState = false;
        vidRecorderBtn.innerText = "Record";
    }
});
